...
| [`kb-research-author`](../.github/skills/kb-research-author/SKILL.md)           | Workflow            | New topics from external sources → canonical MDX, with optional vault context only | Research-from-scratch                                |
...
| Legacy vault note without MDX               | `lint:publish-parity` fails CI                                                           |
