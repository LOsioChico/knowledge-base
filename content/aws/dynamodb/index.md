...
- **Two capacity modes**. **On-demand** (pay per request, no planning, default and recommended for most tables) vs **provisioned** (pre-purchase read/write capacity units; recommended for steady workloads with predictable, forecastable capacity, and pairs with auto-scaling) ([source](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.ReadWriteCapacityMode.html)).
