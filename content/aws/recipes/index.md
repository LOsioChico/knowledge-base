...
- [[aws/rds|RDS]] / [[aws/recipes/cross-account-snapshot|cross-account snapshot]]: re-encrypt under a customer-managed CMK, share the snapshot, restore in the destination account.
