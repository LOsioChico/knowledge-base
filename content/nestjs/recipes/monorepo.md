...
After conversion, `nest-cli.json` looks roughly like this (annotations mark what the schematic added or rewrote vs. the pre-conversion `nest new` file, which only had `collection`, `sourceRoot: "src"`, and a tiny `compilerOptions`):

```jsonc
{
  "collection": "@nestjs/schematics",
  "sourceRoot": "apps/my-app/src", // changed: was "src"
  "monorepo": true, // added: flips this file into monorepo mode
  "root": "apps/my-app", // added: default project for `nest build` / `nest start`
  "compilerOptions": {
    "webpack": true, // added: monorepos bundle with webpack by default
    "tsConfigPath": "apps/my-app/tsconfig.app.json", // added: per-project tsconfig
  },
  "projects": {
    // added: one entry per app, generated by `nest g app`
    "my-app": {
      "type": "application",
      "root": "apps/my-app",
      "entryFile": "main",
