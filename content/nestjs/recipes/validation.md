...
| `@Body() raw: object`                       | `Object`          |        ❌        | The raw POJO (plain old JavaScript object: a literal `{}`, not a class instance) from `body-parser` (no coercion: `transformPrimitive` skips bodies)                                                                                                                                                         |
