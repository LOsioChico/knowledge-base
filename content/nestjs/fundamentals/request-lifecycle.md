...
4. [[interceptors|Interceptors]] inbound: global, controller, route.
5. [[pipes|Pipes]]: global, controller, route, then route parameters in reverse order.
6. **Controller handler** runs.
7. [[interceptors|Interceptors]] outbound: route, controller, global. RxJS observables resolve first in, last out.
