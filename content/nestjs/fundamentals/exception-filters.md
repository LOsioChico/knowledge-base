...
> - The default global `BaseExceptionFilter`'s formatting does **not** apply: the response shape is whatever the platform's error middleware emits (Express defaults to a plain text 500).
