...
Imagine you have a website with a cluster of `N` servers [[nestjs/data/caching|caching]] user session data. When a request comes in, how do you decide which server stores that user's session? 
