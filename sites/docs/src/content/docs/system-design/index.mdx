...
flowchart TD
    ...
    CA --> CM["3. [[system-design/consistency-models|Consistency Models]]"]
    CM --> LC["4. [[system-design/logical-clocks|Logical Clocks]]"]
    CM --> CH["5. [[system-design/consistent-hashing|Consistent Hashing]]"]
```
...
<Tabs>
  <TabItem label="Core Architecture">
    ...
    3. [[system-design/consistency-models|Consistency Models]]: Understand the CAP theorem, sequential/causal models, and client-centric guarantees like Read-Your-Writes.
    4. [[system-design/logical-clocks|Logical Clocks]]: Solve time synchronization limits using Lamport Timestamps and Vector Clocks for causal histories.
    5. [[system-design/consistent-hashing|Consistent Hashing]]: Master data partitioning, circular hashing rings, and hotspot mitigation with virtual nodes.
  ...
  <TabItem label="Algorithmic Primitives">
    ...
    3. **TypeScript Implementation**: Walk through a fully typed hash ring class using MD5 and O(log N) binary search: [[system-design/consistent-hashing#typescript-implementation|Consistent Hashing Code]].
    4. **Causal Timeline Verifications**: Compare vector clocks and trace event ordering: [[system-design/logical-clocks#visualizing-logical-clocks|Causal Tracing]].
