...
[[system-design/back-of-the-envelope-estimation|Estimation Primitives]], [[system-design/distributed-caching|Distributed Caching]], [[system-design/message-queues|Asynchronous Message Queues]], [[system-design/consistent-hashing|Consistent Hashing]], [[system-design/consistency-models|Consistency Models]], and [[system-design/logical-clocks|Logical Clocks]] are the core foundational pillars of distributed software architecture.
...
For a progressive learning flow, we recommend mastering quantitative estimation and cache distribution before diving into the CAP consistency spectrum (consistency models), event coordination (logical clocks), and data distribution rings (consistent hashing):
...
flowchart TD
    ...
    MQ --> CM["4. [[system-design/consistency-models|Consistency Models]]"]
    CM --> LC["5. [[system-design/logical-clocks|Logical Clocks]]"]
    CM --> CH["6. [[system-design/consistent-hashing|Consistent Hashing]]"]
```
...
<Tabs>
  <TabItem label="Core Architecture">
    ...
    4. [[system-design/consistency-models|Consistency Models]]: Understand the CAP theorem, sequential/causal models, and client-centric guarantees like Read-Your-Writes.
    5. [[system-design/logical-clocks|Logical Clocks]]: Solve time synchronization limits using Lamport Timestamps and Vector Clocks for causal histories.
    6. [[system-design/consistent-hashing|Consistent Hashing]]: Master data partitioning, circular hashing rings, and hotspot mitigation with virtual nodes.
  ...
  <TabItem label="Algorithmic Primitives">
    ...
    4. **TypeScript Implementation**: Walk through a fully typed hash ring class using MD5 and O(log N) binary search: [[system-design/consistent-hashing#typescript-implementation|Consistent Hashing Code]].
    5. **Causal Timeline Verifications**: Compare vector clocks and trace event ordering: [[system-design/logical-clocks#visualizing-logical-clocks|Causal Tracing]].
