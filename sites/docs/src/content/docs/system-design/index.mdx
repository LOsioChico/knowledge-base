...
[[system-design/back-of-the-envelope-estimation|Estimation Primitives]], [[system-design/distributed-caching|Distributed Caching]], [[system-design/message-queues|Asynchronous Message Queues]], [[system-design/messaging-patterns|Messaging Patterns]], [[system-design/delivery-semantics|Delivery Semantics]], [[system-design/dead-letter-queues|Dead Letter Queues]], [[system-design/rate-limiting|Rate Limiting & Traffic Shaping]], [[system-design/consistency-models|Consistency Models]], [[system-design/logical-clocks|Logical Clocks]], [[system-design/consistent-hashing|Consistent Hashing]], and [[system-design/distributed-transactions|Distributed Transactions & Saga Patterns]] are the core foundational pillars of distributed software architecture.
...
*   **Messaging Patterns**: Competing consumers, fan-out, consumer groups, and shared subscriptions — the distribution models that determine how messages flow from queues to consumer pools. See [[system-design/messaging-patterns|Messaging Patterns]].
*   **Delivery Semantics**: At-most-once, at-least-once, exactly-once guarantees and idempotency engineering strategies for safe duplicate handling. See [[system-design/delivery-semantics|Delivery Semantics]].
*   **Dead Letter Queues**: Poison pill detection, retry strategies with exponential backoff, DLQ metadata envelopes, and recovery workflows. See [[system-design/dead-letter-queues|Dead Letter Queues]].
...
```mermaid
flowchart TD
    EST["1. Estimation Primitives (Entry)"] --> CA["2. Distributed Caching"]
    CA --> MQ["3. Asynchronous Message Queues"]
    MQ --> RL["4. Rate Limiting & Traffic Shaping"]
    RL --> CM["5. Consistency Models"]
    CM --> LC["6. Logical Clocks"]
    CM --> CH["7. Consistent Hashing"]
    CH --> DT["8. Distributed Transactions & Saga Patterns"]
    CM --> DT
    MQ --> DT

    click EST "/knowledge-base/system-design/back-of-the-envelope-estimation/"
    click CA "/knowledge-base/system-design/distributed-caching/"
    click MQ "/knowledge-base/system-design/message-queues/"
    click RL "/knowledge-base/system-design/rate-limiting/"
    click CM "/knowledge-base/system-design/consistency-models/"
    click LC "/knowledge-base/system-design/logical-clocks/"
    click CH "/knowledge-base/system-design/consistent-hashing/"
    click DT "/knowledge-base/system-design/distributed-transactions/"
```
...
| Asynchronous Message Queues | [Asynchronous Message Queues](/knowledge-base/system-design/message-queues/) | P2P vs Pub/Sub, Brokers vs Logs, Push vs Pull delivery |
| Messaging Patterns | [Messaging Patterns](/knowledge-base/system-design/messaging-patterns/) | Competing Consumers, Fan-Out, Consumer Groups, Shared Subscriptions |
| Delivery Semantics | [Delivery Semantics](/knowledge-base/system-design/delivery-semantics/) | At-most-once, At-least-once, Exactly-once, Idempotency strategies |
| Dead Letter Queues | [Dead Letter Queues](/knowledge-base/system-design/dead-letter-queues/) | Poison pills, Retry strategies, DLQ metadata, Recovery workflows |
