...
<Tabs>
  ...
  <TabItem label="Algorithmic Primitives">
    ...
    7. **Saga Workflow Orchestrator**: Build a self-contained orchestrator managing forward steps and backward compensation rollbacks: [[system-design/distributed-transactions#typescript-saga-orchestrator-implementation|TypeScript Saga Orchestrator Code]].
