...
| **Ephemeral** | Messages delivered only to currently connected subscribers. Disconnected subscribers miss messages permanently. | Real-time dashboards, live metrics, [cache invalidation](/knowledge-base/system-design/distributed-caching/) |
