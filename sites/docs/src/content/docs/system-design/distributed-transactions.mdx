...
- [[system-design/message-queues|Asynchronous Message Queues]]: Master decoupled compute architectures, event brokers vs logs, and delivery semantics.
...
To overcome the performance limits of 2PC, modern distributed systems trade strict ACID properties for **BASE** (Basically Available, Soft [[effect-ts/state|State]], Eventual Consistency) using the **Saga Pattern**.
