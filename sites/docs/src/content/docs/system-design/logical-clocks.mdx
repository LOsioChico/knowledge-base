...
<FlowSimulator
  title="Vector clock propagation across 3 processes"
  speed={1000}
  nodes={[
  ...
  flows={[
    { label: "Vector clock trace", steps: [
      { from: "A", to: "A", message: "a1 (local) → V=[1,0,0]" },
      { from: "A", to: "B", message: "a2 (send) → A attaches V=[2,0,0]" },
      { from: "B", to: "B", message: "b1 (local) → V=[0,1,0]" },
      { from: "B", to: "B", message: "b2 (recv Msg 1) → merge max([0,1,0],[2,0,0])+1 → V=[2,2,0]" },
      { from: "B", to: "C", message: "b3 (send) → B attaches V=[2,3,0]" },
      { from: "C", to: "C", message: "c1 (recv Msg 2) → merge max([0,0,0],[2,3,0])+1 → V=[2,3,1]" },
      { from: "C", to: "C", message: "c2 (local) → V=[2,3,2]" },
    ]},
  ]}
/>
