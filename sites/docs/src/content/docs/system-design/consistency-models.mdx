...
- [[system-design/back-of-the-envelope-estimation|Estimation Primitives]]: Master the powers of two, network latency boundaries, and compounding availability math.
