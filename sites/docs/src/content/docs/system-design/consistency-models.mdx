...
This note is part of the **[Systems Design Track](/knowledge-base/system-design/)**. Before resolving CAP theorem partition trade-offs and consistency spectrums, make sure you understand:
