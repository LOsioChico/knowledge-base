...
- **Decoupled Architecture with EventBridge**: Designing event-driven communication channels using standard/custom buses, rule targets, [[effect-ts/schema|schema]] registries, and secure cross-account event routing.
- **Distributed Observability with CloudWatch & X-Ray**: Setting up trace context propagation, CloudWatch log aggregation, alarm configurations, and service maps.
