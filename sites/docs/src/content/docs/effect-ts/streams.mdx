...
<FiberTimeline
  ...
  lanes={[
    { id: "producer", label: "Producer Fiber", color: "#60a5fa" },
    { id: "consumer", label: "Consumer Fiber", color: "#a78bfa" },
  ]}
  segments={[
    { lane: "producer", start: 0, end: 0, state: "active", label: "emit 1", tip: "Producer pushes element 1 into the bounded buffer (capacity: 2). Buffer: [1]" },
    { lane: "producer", start: 1, end: 1, state: "active", label: "emit 2", tip: "Producer pushes element 2 — buffer is now full (2/2). Buffer: [1, 2]" },
    { lane: "producer", start: 2, end: 2, state: "blocked", label: "buffer full", tip: "Buffer is at capacity — producer suspends. Consumer's pull (same tick) frees a slot." },
    { lane: "consumer", start: 2, end: 2, state: "active", label: "pull 1" },
    { lane: "producer", start: 3, end: 3, state: "active", label: "emit 3", tip: "Slot freed → producer resumes immediately and pushes element 3" },
    { lane: "consumer", start: 3, end: 3, state: "active", label: "process" },
    { lane: "producer", start: 4, end: 4, state: "blocked", label: "full again" },
    { lane: "consumer", start: 4, end: 4, state: "active", label: "pull 2" },
    { lane: "producer", start: 5, end: 5, state: "active", label: "emit 4" },
    { lane: "consumer", start: 5, end: 5, state: "active", label: "process" },
  ]}
  events={[
    { time: 2, from: "consumer", to: "producer", label: "frees slot" },
    { time: 4, from: "consumer", to: "producer", label: "frees slot" },
  ]}
  steps={6}
/>
