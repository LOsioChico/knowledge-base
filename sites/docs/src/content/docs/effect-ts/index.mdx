...
<CardGrid>
  ...
  <Card title="Step 11: State coordinates" icon="seti:db">
    <p>
      <a href="/knowledge-base/effect-ts/state/">Lock-free fiber coordinates</a>: <code>[[effect-ts/state|Ref]]</code>, <code>SubscriptionRef</code>, and Software Transactional Memory (STM).
    </p>
  </Card>
