...
flowchart TD
    ...
    ST --> AR["12. [[effect-ts/async-result|AsyncResult State Machine]]"]
    AR --> OBS["13. [[effect-ts/observability|Observability]]"]
    OBS --> PLT["14. [[effect-ts/platform|Platform Layers]]"]
    PLT --> FT["15. [[effect-ts/fault-tolerant-ingestion|Ingestion Capstone]]"]
```
