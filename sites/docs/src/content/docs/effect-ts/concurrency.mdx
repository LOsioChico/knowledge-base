...
<FiberTimeline
  ...
  lanes={[
    { id: "parent", label: "Parent Fiber", color: "#60a5fa" },
    { id: "child", label: "Child Fiber", color: "#a78bfa" },
  ]}
  segments={[
    { lane: "parent", start: 0, end: 0, state: "active", label: "start" },
    { lane: "parent", start: 1, end: 1, state: "active", label: "fork + work", tip: "Effect.fork(backgroundJob) spawns the child fiber. Parent immediately continues with Console.log — no waiting." },
    ...
    { lane: "parent", start: 4, end: 4, state: "active", label: "resumed", tip: "Child returned 42 → parent unblocks, receives the value, and logs it" },
  ]}
  events={[
    { time: 1, from: "parent", to: "child", label: "fork" },
    { time: 3, from: "child", to: "parent", label: "return 42" },
  ]}
  steps={5}
/>
