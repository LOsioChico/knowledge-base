...
const effectTsSidebar = [
  ...
  { label: "1. What is Effect", slug: "effect-ts/what-is-effect" },
  { label: "2. Quickstart", slug: "effect-ts/quickstart" },
  { label: "3. Composition", slug: "effect-ts/composition" },
  { label: "4. Typed errors", slug: "effect-ts/typed-errors" },
  { label: "5. Schema", slug: "effect-ts/schema" },
  { label: "6. Layers and DI", slug: "effect-ts/layers-and-di" },
  { label: "7. Retry and Schedule", slug: "effect-ts/retry-and-schedule" },
  { label: "8. Scoped resources", slug: "effect-ts/scoped-resources" },
  { label: "9. Concurrency", slug: "effect-ts/concurrency" },
  { label: "10. Streams", slug: "effect-ts/streams" },
  { label: "11. State coordinates", slug: "effect-ts/state" },
  { label: "12. AsyncResult", slug: "effect-ts/async-result" },
  { label: "13. Observability", slug: "effect-ts/observability" },
  { label: "14. Platform layers", slug: "effect-ts/platform" },
  {
    label: "15. Fault-tolerant ingestion",
...
const nestjsSidebar = [
  { label: "Overview", slug: "nestjs" },
  {
    ...
    items: [
      ...
      {
        label: "1. Request lifecycle",
        slug: "nestjs/fundamentals/request-lifecycle",
      },
      { label: "2. Middleware", slug: "nestjs/fundamentals/middleware" },
      { label: "3. Guards", slug: "nestjs/fundamentals/guards" },
      { label: "4. Interceptors", slug: "nestjs/fundamentals/interceptors" },
      { label: "5. Pipes", slug: "nestjs/fundamentals/pipes" },
      { label: "6. Exception filters", slug: "nestjs/fundamentals/exception-filters" },
      { label: "7. Global enhancers", slug: "nestjs/fundamentals/global-providers" },
      { label: "8. Lifecycle hooks", slug: "nestjs/fundamentals/lifecycle-hooks" },
    ],
  },
  {
    label: "Recipes",
