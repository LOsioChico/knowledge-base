...
| --------------------------------- | ----------------------------------------------------------------------------------------- |
| `bun run lint:wikilinks`          | Wikilink linter (`lint-wikilinks.mjs`)                                              |
| `bun run lint:publish-parity`     | MDX page count health check (`check-publish-parity.mjs`)                                  |
...
| `bun run vault:check`             | Publish parity + diff-scoped MDX Pass 0 + optional `mdx-triage` + `lint:docs` |
